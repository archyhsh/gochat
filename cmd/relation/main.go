...
var (
	configFile = flag.String("config", "configs/relation.yaml", "config file path")
	version    = "1.0.0"
)
...
func main() {
	...
	log.Info("Starting Relation Service", "version", version)
	...
	go func() {
		log.Info("Relation Service listening", "addr", cfg.Server.GRPCAddr)
