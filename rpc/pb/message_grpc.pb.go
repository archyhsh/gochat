...
func (c *messageServiceClient) ClearUnread(ctx context.Context, in *ClearUnreadRequest, opts ...grpc.CallOption) (*ClearUnreadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ClearUnreadResponse)
	err := c.cc.Invoke(ctx, MessageService_ClearUnread_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMessageServiceServer) ClearUnread(context.Context, *ClearUnreadRequest) (*ClearUnreadResponse, error) {
...
func _MessageService_ClearUnread_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClearUnreadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessageServiceServer).ClearUnread(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageService_ClearUnread_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).ClearUnread(ctx, req.(*ClearUnreadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MessageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gochat.rpc.MessageService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MessageService_ClearUnread_Handler,
		},
		{
